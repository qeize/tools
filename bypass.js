...
function getRandomUserAgent() {
 ...
 if (process.argv.length < 7){console.log(`DDG\n Usage: node ddg.js target time rate thread proxy.txt`); process.exit();}
